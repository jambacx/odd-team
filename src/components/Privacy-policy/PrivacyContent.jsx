                ...
                <div className="privacy-nav-wrapper">
                  ...
                  <ul className="nav nav-tabs flex-column" id="privacy-nav" role="tablist">
                    <li className="nav-item" role="presentation">
                      <button className="nav-link active" id="administrator-tab" data-bs-toggle="tab" data-bs-target="#administrator" type="button" role="tab" aria-controls="administrator" aria-selected="true">Website administrator</button>
                    </li>
                    <li className="nav-item" role="presentation">
