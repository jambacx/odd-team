  ...
  return (
    <>
      <section className="tp-minimal__area position-relative">
        <div
          className="tp-minimal__design-thumb"
          style={{
            backgroundImage: `url(assets/img/about/5/ab-img-4.jpg)`,
            ...
            <div className="col-xl-6 col-lg-6 col-md-6">
              <div className="tp-minimal__design pt-100 pb-100">
                <div className="tp-minimal__design-wrapper">
                  <h2 className="tp-minimal__design-title">
                    Outsourcing <br /> <span>Development</span>
                  </h2>
                  <p className="tpds-text">
                    We are working on a professional, visually Website <br />{" "}
